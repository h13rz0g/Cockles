...
namespace Cockles.Code
{
    public class OperatorProvider
    {
        ...
        private string LoginUserKey = "Cockles_loginuserkey_2016";
        ...
        public void AddCurrent(OperatorModel operatorModel)
        {
            ...
            WebHelper.WriteCookie("Cockles_mac", Md5.md5(Net.GetMacByNetworkInterface().ToJson(), 32));
            WebHelper.WriteCookie("Cockles_licence", Licence.GetLicence());
        }
